...
const bot = {
  ...
  every: function () {
    ...
    bot.sidecircle_r = canvasUtil.circle(
      window.snake.lnp.xx -
        (window.snake.lnp.yy + bot.sin * bot.snakeWidth - window.snake.lnp.yy),
      window.snake.lnp.yy +
        (window.snake.lnp.xx + bot.cos * bot.snakeWidth - window.snake.lnp.xx),
